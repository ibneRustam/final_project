...
class _TabletState extends State<Tablet> {
  ...
  List<Product> tablet = [
    Product(1, 'Tablet 1', 'Latest model with high performance', 12000, "assets/image/tab1.jpg"),
    Product(2, 'Tablet 2', 'Latest model with high performance', 12000, "assets/image/tab2.jpg"),
    Product(3, 'Tablet 3', 'Latest model with high performance', 12000, "assets/image/tab3.jpg"),
    Product(4, 'Tablet 4', 'Latest model with high performance', 12000, "assets/image/tab4.jpg"),
    Product(5, 'Tablet 5', 'Latest model with high performance', 12000, "assets/image/tab5.jpg"),
    Product(6, 'Tablet 6', 'Latest model with high performance', 12000, "assets/image/tab6.jpg"),
    Product(7, 'Tablet 7', 'Latest model with high performance', 12000, "assets/image/tab7.jpg"),
    Product(8, 'Tablet 8', 'Latest model with high performance', 12000, "assets/image/tab8.jpg"),
  ];
